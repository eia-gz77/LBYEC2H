...
\label{sec:res1}
        ...
        \item Standard circuit analysis textbooks confirm that unique solutions exist for linear resistive circuits with independent sources [1].
...
\label{sec:res2}
        ...
        \item This analysis is standard in linear algebra coursework for understanding matrix properties [2].
